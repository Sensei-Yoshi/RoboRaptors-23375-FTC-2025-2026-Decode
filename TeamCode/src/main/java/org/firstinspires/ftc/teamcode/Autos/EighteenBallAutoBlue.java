...
@Autonomous(name = "18 Ball Blue")
public class EighteenBallAutoBlue extends OpMode {
    ...
    private final Pose scorePose = new Pose(85, 85, Math.toRadians(41)).mirror();
    private final Pose pickup1Pose = new Pose(123, 83, Math.toRadians(0)).mirror();
    ...
    private final Pose gatePose = new Pose(120, 64, Math.toRadians(0)).mirror();
    private final Pose pickGatePose = new Pose(127.5, 49.5, Math.toRadians(75)).mirror();
    private final Pose runGatePose = new Pose(127.5, 58, Math.toRadians(75)).mirror();
    private final Pose finalScorePose = new Pose(95, 112, Math.toRadians(35)).mirror();
    ...
    public void buildPaths() {
        ...
        grabPickup2 = follower.pathBuilder() //gets next 3
                .addPath(new BezierCurve(scorePose,(new Pose(82, 55)).mirror(), pickup3Pose))
        ...
        scoreGate = follower.pathBuilder()
                .addPath(new BezierCurve(runGatePose, (new Pose(79, 67)).mirror(), scorePose))
