...
public class FarShootBlue extends OpMode {
    ...
    private final Pose scorePose     = new Pose(84.2,  14,   Math.toRadians(65)).mirror();
    private final Pose park          = new Pose(128,   9, Math.toRadians(0)).mirror();
    private final Pose runBackPose   = new Pose(123,   9, Math.toRadians(0)).mirror();
