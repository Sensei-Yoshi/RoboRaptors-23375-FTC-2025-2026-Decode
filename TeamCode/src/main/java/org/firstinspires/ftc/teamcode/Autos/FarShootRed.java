...
public class FarShootRed extends OpMode {
    ...
    private static final double TARGET_RPM = 1368;   // original far-shot velocity
    private static final double RPM_TOL    = 50;

    // ─── Poses ───────────────────────────────────────────────────────────────
    private final Pose startPose = new Pose(87,    8,   Math.toRadians(90));
    private final Pose scorePose = new Pose(84.2,  12, Math.toRadians(63));
    private final Pose park      = new Pose(127,   10.3,   Math.toRadians(0));
    private final Pose runBackPose     = new Pose(125,   10.3,   Math.toRadians(0));
