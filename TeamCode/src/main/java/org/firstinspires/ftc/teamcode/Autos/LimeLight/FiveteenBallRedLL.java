...
public class FiveteenBallRedLL extends OpMode {
    ...
    public void buildPaths() {
        ...
        gatePush = follower.pathBuilder()
                .addPath(new BezierCurve(scorePose, (new Pose(76, 67)), gatePose))
        ...
        scorePickup3 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(pickup5Pose.getHeading(), Math.toRadians(43))
                .build();

        scoreGate = follower.pathBuilder()
                .addPath(new BezierCurve(gatePose, (new Pose(76, 67)), scorePose))
                .setLinearHeadingInterpolation(pickup3Pose.getHeading(), Math.toRadians(43))
                .build();
    }
